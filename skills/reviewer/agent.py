"""
BEACON Skill Agent — Code / Document Reviewer
...
class ReviewerAgent:
    """Code / Document Reviewer — Reviews code, documents and designs with Critical/Major/Minor/Nitpick grading and actionable feedback."""
    skill_id = "reviewer"
    version = "1.0.0"
    display_name = "Code / Document Reviewer"
    description = "Reviews code, documents and designs with Critical/Major/Minor/Nitpick grading and actionable feedback."
    ...
    def execute(self, inputs: dict) -> SkillResult:
        ...
        try:
            ...
            steps = [
                ...
                f"2. Apply Code / Document Reviewer expertise and domain knowledge",
            ...
            result_data = {
                ...
                "outputs": {k: f"[Code / Document Reviewer — {k} output]" for k in output_schema},
                "ready_for_llm": True
            }

...
class ResearcherAgent:
    """Researcher — Conducts deep multi-source research, synthesises findings and produces structured executive summaries."""
    skill_id = "researcher"
    version = "1.0.0"
    display_name = "Researcher"
    description = "Conducts deep multi-source research, synthesises findings and produces structured executive summaries."
    ...
    def execute(self, inputs: dict) -> SkillResult:
        ...
        try:
            ...
            steps = [
                ...
                f"2. Apply Researcher expertise and domain knowledge",
            ...
            result_data = {
                ...
                "outputs": {k: f"[Researcher — {k} output]" for k in output_schema},
                "ready_for_llm": True
            }

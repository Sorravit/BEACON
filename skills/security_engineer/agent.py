"""
BEACON Skill Agent — Security Engineer
...
class SecurityEngineerAgent:
    """Security Engineer — Performs STRIDE threat modelling, OWASP Top 10 review, CVE triage and remediation planning."""
    skill_id = "security_engineer"
    version = "1.0.0"
    display_name = "Security Engineer"
    description = "Performs STRIDE threat modelling, OWASP Top 10 review, CVE triage and remediation planning."
    ...
    def execute(self, inputs: dict) -> SkillResult:
        ...
        try:
            ...
            steps = [
                ...
                f"2. Apply Security Engineer expertise and domain knowledge",
            ...
            result_data = {
                ...
                "outputs": {k: f"[Security Engineer — {k} output]" for k in output_schema},
                "ready_for_llm": True
            }

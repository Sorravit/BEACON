"""
BEACON Skill Agent — Stock Market Analyst
...
class StockMarketAnalystAgent:
    """Stock Market Analyst — Performs fundamental and technical analysis, identifies risk factors and generates investment thesis summaries."""
    skill_id = "stock_market_analyst"
    version = "1.0.0"
    display_name = "Stock Market Analyst"
    description = "Performs fundamental and technical analysis, identifies risk factors and generates investment thesis summaries."
    ...
    def execute(self, inputs: dict) -> SkillResult:
        ...
        try:
            ...
            steps = [
                ...
                f"2. Apply Stock Market Analyst expertise and domain knowledge",
            ...
            result_data = {
                ...
                "outputs": {k: f"[Stock Market Analyst — {k} output]" for k in output_schema},
                "ready_for_llm": True
            }

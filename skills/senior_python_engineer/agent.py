"""
BEACON Skill Agent — Senior Python Engineer
...
class SeniorPythonEngineerAgent:
    """Senior Python Engineer — Builds FastAPI services, async handlers, Pydantic schemas, pytest suites and pyproject.toml configs."""
    skill_id = "senior_python_engineer"
    version = "1.0.0"
    display_name = "Senior Python Engineer"
    description = "Builds FastAPI services, async handlers, Pydantic schemas, pytest suites and pyproject.toml configs."
    ...
    def execute(self, inputs: dict) -> SkillResult:
        ...
        try:
            ...
            steps = [
                ...
                f"2. Apply Senior Python Engineer expertise and domain knowledge",
            ...
            result_data = {
                ...
                "outputs": {k: f"[Senior Python Engineer — {k} output]" for k in output_schema},
                "ready_for_llm": True
            }

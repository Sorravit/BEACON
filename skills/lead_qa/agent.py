"""
BEACON Skill Agent — Lead QA Engineer
...
class LeadQaAgent:
    """Lead QA Engineer — Defines QA strategy, test plans, quality gates, defect triage policy and team standards."""
    skill_id = "lead_qa"
    version = "1.0.0"
    display_name = "Lead QA Engineer"
    description = "Defines QA strategy, test plans, quality gates, defect triage policy and team standards."
    ...
    def execute(self, inputs: dict) -> SkillResult:
        ...
        try:
            ...
            steps = [
                ...
                f"2. Apply Lead QA Engineer expertise and domain knowledge",
            ...
            result_data = {
                ...
                "outputs": {k: f"[Lead QA Engineer — {k} output]" for k in output_schema},
                "ready_for_llm": True
            }

"""
BEACON Skill Agent — Backend Engineer
...
class BackendEngineerAgent:
    """Backend Engineer — Designs OpenAPI specs, implements handlers, SQL DDL schemas and data access patterns."""
    skill_id = "backend_engineer"
    version = "1.0.0"
    display_name = "Backend Engineer"
    description = "Designs OpenAPI specs, implements handlers, SQL DDL schemas and data access patterns."
    ...
    def execute(self, inputs: dict) -> SkillResult:
        ...
        try:
            ...
            steps = [
                ...
                f"2. Apply Backend Engineer expertise and domain knowledge",
            ...
            result_data = {
                ...
                "outputs": {k: f"[Backend Engineer — {k} output]" for k in output_schema},
                "ready_for_llm": True
            }

"""
BEACON Skill Agent — Financial Analyst
...
class FinancialAnalystAgent:
    """Financial Analyst — Calculates NPV, ROI, payback period, cost-benefit projections and sensitivity analysis tables."""
    skill_id = "financial_analyst"
    version = "1.0.0"
    display_name = "Financial Analyst"
    description = "Calculates NPV, ROI, payback period, cost-benefit projections and sensitivity analysis tables."
    ...
    def execute(self, inputs: dict) -> SkillResult:
        ...
        try:
            ...
            steps = [
                ...
                f"2. Apply Financial Analyst expertise and domain knowledge",
            ...
            result_data = {
                ...
                "outputs": {k: f"[Financial Analyst — {k} output]" for k in output_schema},
                "ready_for_llm": True
            }

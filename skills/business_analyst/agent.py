"""
BEACON Skill Agent — Business Analyst
...
class BusinessAnalystAgent:
    """Business Analyst — Produces BRDs, user stories, gap analysis, stakeholder mapping and risk registers."""
    skill_id = "business_analyst"
    version = "1.0.0"
    display_name = "Business Analyst"
    description = "Produces BRDs, user stories, gap analysis, stakeholder mapping and risk registers."
    ...
    def execute(self, inputs: dict) -> SkillResult:
        ...
        try:
            ...
            steps = [
                ...
                f"2. Apply Business Analyst expertise and domain knowledge",
            ...
            result_data = {
                ...
                "outputs": {k: f"[Business Analyst — {k} output]" for k in output_schema},
                "ready_for_llm": True
            }

"""
BEACON Skill Agent — Automation QA Engineer (Cypress)
...
class AutomatedQaCypressAgent:
    """Automation QA Engineer (Cypress) — Writes Cypress E2E test specs in TypeScript using Page Object Model with CI/CD integration."""
    skill_id = "automated_qa_cypress"
    version = "1.0.0"
    display_name = "Automation QA Engineer (Cypress)"
    description = "Writes Cypress E2E test specs in TypeScript using Page Object Model with CI/CD integration."
    ...
    def execute(self, inputs: dict) -> SkillResult:
        ...
        try:
            ...
            steps = [
                ...
                f"2. Apply Automation QA Engineer (Cypress) expertise and domain knowledge",
            ...
            result_data = {
                ...
                "outputs": {k: f"[Automation QA Engineer (Cypress) — {k} output]" for k in output_schema},
                "ready_for_llm": True
            }

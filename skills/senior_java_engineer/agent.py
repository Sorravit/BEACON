"""
BEACON Skill Agent — Senior Java Engineer
...
class SeniorJavaEngineerAgent:
    """Senior Java Engineer — Designs Spring Boot services, REST APIs, JUnit5 tests and Maven build configurations."""
    skill_id = "senior_java_engineer"
    version = "1.0.0"
    display_name = "Senior Java Engineer"
    description = "Designs Spring Boot services, REST APIs, JUnit5 tests and Maven build configurations."
    ...
    def execute(self, inputs: dict) -> SkillResult:
        ...
        try:
            ...
            steps = [
                ...
                f"2. Apply Senior Java Engineer expertise and domain knowledge",
            ...
            result_data = {
                ...
                "outputs": {k: f"[Senior Java Engineer — {k} output]" for k in output_schema},
                "ready_for_llm": True
            }

"""
BEACON Skill Agent — Senior QA Engineer
...
class SeniorQaAgent:
    """Senior QA Engineer — Designs and executes detailed test cases covering positive, negative, boundary and exploratory scenarios."""
    skill_id = "senior_qa"
    version = "1.0.0"
    display_name = "Senior QA Engineer"
    description = "Designs and executes detailed test cases covering positive, negative, boundary and exploratory scenarios."
    ...
    def execute(self, inputs: dict) -> SkillResult:
        ...
        try:
            ...
            steps = [
                ...
                f"2. Apply Senior QA Engineer expertise and domain knowledge",
            ...
            result_data = {
                ...
                "outputs": {k: f"[Senior QA Engineer — {k} output]" for k in output_schema},
                "ready_for_llm": True
            }
